                ...
                <div class="card-body">
                    <div class="media d-flex">
                        ...
                        <div class="media-body flex-grow-1">
                            <h4 class="project-title"><a href="<?php echo $p['link_done'];?>"><?php echo $p['name'];?></a></h4>
                            <h6 class="project-text">3 open tasks, 3 tasks completed</h6>
                        </div>
                    </div>
                    <p class="project-p"><?php echo $p['instruction'];?></p>
                    <ul class="cost-li">
                        <li>
                            <h5>Begin date</h5>
                            <h6><?php echo date("jS M Y H:i:s",strtotime($p['start_date']));?></h6>
                        </li>
                        <li>
                            <h5>Deadline</h5>
                            <h6><?php echo date("jS M Y H:i:s",strtotime($p['end_date']));?></h6>
                        </li>
                    </ul>
                    <ul class="team-li">
                        <li>
                            ...
                            <a href="#" data-bs-toggle="tooltip" title="Jeffery Lalor"><img
                                    src="<?php echo _WEB_ROOT; ?>/public/assets/img/profiles/avatar-16.jpg"
                                    alt="User Image"></a>
                        </li>
                        <li>
                            <h5>Team</h5>
                            <ul class="team-members">
                                ...
                                <li>
                                    <a href="#" data-bs-toggle="tooltip" title="Mike Litorus"><img
                                            src="<?php echo _WEB_ROOT; ?>/public/assets/img/profiles/avatar-05.jpg"
                                            alt="User Image"></a>
                                </li>
                                <li class="dropdown avatar-dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <div class="avatar-group">
                                            ...
                                            <a class="avatar avatar-xs" href="#">
                                                <img src="<?php echo _WEB_ROOT; ?>/public/assets/img/profiles/avatar-09.jpg"
                                                    alt="User Image">
                                            </a>
                                            <a class="avatar avatar-xs" href="#">
                                                <img src="<?php echo _WEB_ROOT; ?>/public/assets/img/profiles/avatar-10.jpg"
                                                    alt="User Image">
                                            </a>
                                            <a class="avatar avatar-xs" href="#">
                                            ...
                                            <a class="avatar avatar-xs" href="#">
                                                <img src="<?php echo _WEB_ROOT; ?>/public/assets/img/profiles/avatar-11.jpg"
                                                    alt="User Image">
                                            </a>
                                            <a class="avatar avatar-xs" href="#">
                                                <img src="<?php echo _WEB_ROOT; ?>/public/assets/img/profiles/avatar-12.jpg"
                                                    alt="User Image">
                                            </a>
                                            <a class="avatar avatar-xs" href="#">
                    ...
                    <div class="progress progress-sm mb-0">
                        <div class="progress-bar progress-profile bg-blue" role="progressbar" data-bs-toggle="tooltip"
                            title="40%"></div>
                    </div>
                </div>
            </div>
