    ...
    <ul class="header-new-menu">
        <li>
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="<?php echo _WEB_ROOT?>/tla/project">List</a>
                <a class="dropdown-item" href="<?php echo _WEB_ROOT?>/tla/task">Tasks</a>
                <a class="dropdown-item" href="<?php echo _WEB_ROOT?>/tla/task/owntask">Your tasks</a>
            </div>
        </li>       
    </ul>
